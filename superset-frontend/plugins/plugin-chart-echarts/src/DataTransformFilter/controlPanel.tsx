...
import { customElements, DEFAULT_FORM_DATA } from './constants';
import {
  legendSection,
  minorTicks,
  richTooltipSection,
...
import { TIME_SERIES_DESCRIPTION_TEXT } from '../Timeseries/constants';
...
const queryControls = {
  ...
  controlSetRows: [
    ...sections.echartsTimeSeriesQuery.controlSetRows.map(sec =>
      sec.includes('metrics') ? ['metric'] : sec,
    ),
    ['columns'],
  ],
};
